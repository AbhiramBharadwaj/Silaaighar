                  ...
                  <div className="space-y-4 p-4 bg-rose-50 rounded-lg border-l-4 border-rose-400">
                            ...
                            <div className="space-y-4 p-4 bg-white rounded border">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <Select
                                    value={formData.serviceDetails.customStitching?.measurementsUnit ?? "cm"}
                                    onValueChange={(val) =>
                                      handleInputChange("serviceDetails.customStitching.measurementsUnit", val)
                                    }
                                  >
                                  ...
                                  <div key={field} className="space-y-1">
                                    ...
                                    <div className="relative">
                                      ...
                                      <span className="absolute right-2 top-2 text-xs text-gray-500">
                                        {formData.serviceDetails.customStitching?.measurementsUnit ?? "cm"}
                                      </span>
                                    </div>
                                  </div>
                                ))}
                    ...
                    {formData.serviceType === "Embroidery" && (
                      <div className="space-y-4">
                        ...
                        <div className="space-y-4 p-4 bg-white rounded border">
                          <div className="flex items-center justify-between">
                            <h5 className="font-medium">Embroidery Area</h5>
                            <div className="flex items-center gap-2">
                              <span className="text-xs text-gray-500">Units</span>
                              <Select
                                value={formData.serviceDetails.embroidery?.areaUnit ?? "cm"}
                                onValueChange={(val) => handleInputChange("serviceDetails.embroidery.areaUnit", val)}
                              >
                                <SelectTrigger className="h-8 w-24">
                                  <SelectValue placeholder="cm" />
                                </SelectTrigger>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              />
                              <span className="absolute right-2 top-2 text-xs text-gray-500">
                                {formData.serviceDetails.embroidery?.areaUnit ?? "cm"}
                              </span>
                            </div>
                          </div>
                          <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) => handleInputChange("serviceDetails.embroidery.areaUnit", value)}
                          >
                            <SelectTrigger>
                              ...
                              {formData.serviceDetails.alteration?.requiredChanges?.includes("Length") && (
                                <div className="ml-6 space-y-2">
                                  <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <Select
                                      onValueChange={(value) =>
                                        handleInputChange("serviceDetails.alteration.lengthUnit", value)
                                      }
                                    >
                                      <SelectTrigger>
                                ...
                                <div className="ml-6 space-y-2">
                                  ...
                                  {formData.serviceDetails.alteration?.fitAreas?.map((area) => (
                                    <div key={area} className="flex items-center space-x-2">
                                      ...
                                      <Select
                                        onValueChange={(value) =>
                                          handleInputChange(`serviceDetails.alteration.fitUnits.${area}`, value)
                                        }
                                      >
                                        <SelectTrigger>
                                          <SelectValue placeholder="Unit" />
                            ...
                            <div className="space-y-2">
                              ...
                              {formData.serviceDetails.alteration?.requiredChanges?.includes("Sleeve") && (
                                <div className="ml-6 grid grid-cols-2 gap-2">
                                  ...
                                  <Select
                                    onValueChange={(value) =>
                                      handleInputChange("serviceDetails.alteration.sleeveUnit", value)
                                    }
                                  >
                                    <SelectTrigger>
                                      <SelectValue placeholder="Unit" />
                        ...
                        <div className="space-y-2">
                          ...
                          {formData.serviceDetails.alteration?.waistbandAdjust && (
                            <div className="ml-6 grid grid-cols-2 gap-2">
                              ...
                              <Select
                                onValueChange={(value) =>
                                  handleInputChange("serviceDetails.alteration.waistbandUnit", value)
                                }
                              >
                                <SelectTrigger>
                                  <SelectValue placeholder="Unit" />
                          ...
                          <div className="space-y-2">
                            ...
                            {formData.serviceDetails.alteration?.zipRepair && (
                              <div className="ml-6">
                                ...
                                <Select
                                  onValueChange={(value) =>
                                    handleInputChange("serviceDetails.alteration.zipUnit", value)
                                  }
                                >
                                  <SelectTrigger>
                                    <SelectValue placeholder="Unit" />
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Select
                              onValueChange={(value) => handleInputChange("serviceDetails.repair.openingUnit", value)}
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Unit" />
                              </SelectTrigger>
                        ...
                        <div className="space-y-2">
                          ...
                          {formData.serviceDetails.repair?.matchingFabricAvailable === "Yes" && (
                            <div className="mt-2">
                              ...
                              <Select
                                onValueChange={(value) =>
                                  handleInputChange("serviceDetails.repair.fabricPieceUnit", value)
                                }
                              >
                                <SelectTrigger>
                                  <SelectValue placeholder="Unit" />
                            ...
                            <div className="space-y-4 p-4 bg-white rounded border">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  <span className="text-xs text-gray-500">Units</span>
                                  <Select
                                    value={formData.serviceDetails.blouse?.measurementsUnit ?? "cm"}
                                    onValueChange={(val) =>
                                      handleInputChange("serviceDetails.blouse.measurementsUnit", val)
                                    }
                                  >
                                    <SelectTrigger className="h-8 w-24">
                                      <SelectValue placeholder="cm" />
                                ...
                                {[
                                  ...
                                  <div key={field} className="space-y-1">
                                    ...
                                    <div className="relative">
                                      ...
                                      />
                                      <span className="absolute right-2 top-2 text-xs text-gray-500">
                                        {formData.serviceDetails.blouse?.measurementsUnit ?? "cm"}
                                      </span>
                                    </div>
                                  </div>
                                ))}
